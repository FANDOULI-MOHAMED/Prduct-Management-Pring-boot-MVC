...
<nav class="navbar navbar-expand-lg navbar-light bg-light" style="background-color: #7E909A;">
  ...
  <div class="collapse navbar-collapse" id="navbarSupportedContent">
    <ul class="navbar-nav mr-auto">
      ...
      <!--  <a class="nav-link" href="/ProductController/all">liste des produits</a>-->
      </li>
      <li class="nav-item">
        <a class="nav-link" href="/ProductController/ajouter">Add Product</a>
      </li>
       <li class="nav-item">
        <a class="nav-link" href="/CategorieController/all">Categories</a>
      </li>
     </ul>
  </div>
</nav>
...
<div>
	<form class="form-inline my-2 my-lg-0" action="/ProductController/search" method="Get">
      <input class="form-control mr-sm-2 type="text" placeholder="Search" name="mc">
      <button class="btn btn-outline-success my-2 my-sm-0" type="submit" name=act value=search>Search</button>
    </form>
</div>
